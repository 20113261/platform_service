...
from SDK.CtripPoiCitySDK import CtripPoiSDK
from SDK.CtripPoiCityDetailSDK import CtripPoiDetailSDK
...
class NormalTaskSDK(BaseSDK):
    ...
    def get_task_sdk(self,source=None):
        all_sdk = {
             ...
             'ctrippoidetail':CtripPoiDetailSDK
        }
        class_name = None
        source = source.lower()
...
if __name__ == "__main__":
    ...
    task = Task(_worker='', _task_id='demo', _source='ctrippoi', _type='poi_list', _task_name='ctrip_poi_suggest',
