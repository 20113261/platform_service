...
class cheapticketsHotelHotelSpider(BaseHotelSpider):
    source_type = 'cheapticketsHotel'
    targets = {
        'hotel': {},
    ...
    #   对应多个原爬虫
    old_spider_tag = {
        'cheapticketsHotel': {'required': ['room']}
    }
...
if __name__ == '__main__':
    ...
    task.content = 'https://www.expedia.com.hk/Hotels-Golden-Nugget-Las-Vegas-Hotel-Casino.h43312.Hotel-Information?&&1&&20180119'
    spider = cheapticketsHotelHotelSpider()
    spider.task = task
