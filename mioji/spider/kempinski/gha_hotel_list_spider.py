...
class GhaListSpider(Spider):
    ...
    def targets_request(self):
        ...
        if city:
            url = "https://zh.gha.com/ajaxgha/get_country_hotels/{}?related_object=state".format(cityid)
        else:
            url = "https://zh.gha.com/ajaxgha/get_country_hotels/{}".format(cityid)
