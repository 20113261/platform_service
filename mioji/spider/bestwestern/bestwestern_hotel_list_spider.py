    ...
    def __get_checkOutDate(self,startDate,day):
        ...
        if checkInMonth in ['01','03','05','07','08','10','12']:
            ...
            if 30 < int(checkInDate) + day < 61:
                ...
                checkOutDate = int(int(checkInDate) + day - 30)
                if checkOutDate < 10:
                    # 退房日期
                    checkOutDate = '0' + str(checkOutDate)
                else:
...
if __name__ == '__main__':
    Spider.slave_get_proxy = get_zxp_proxy
    task = Task()
    # task.content = "&Berlin, 德国&20180420&2"
    task.content = '&印度喀拉拉邦恰拉库德伊&20180501&2'
    task.ticket_info = {'locationLng':'13.404954','locationLat':'52.5200066'}
    hotel_spider = HotelSpider(task)
    hotel_spider.crawl()
