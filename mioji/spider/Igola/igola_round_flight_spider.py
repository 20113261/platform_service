...
class igolaFlightSpider(Spider):
    ...
    #   对应多个原爬虫
    old_spider_tag = {
        'igolaRoundFlight': {'required': ['RoundFlight']}
    }
    ...
    def targets_request(self):
        ...
        def poll():
            ...
            while True:
                # if self.api.is_end() or self.failure_count > 5:
    ...
    def parse_RoundFlight(self, req, resp):
        ...
        if 'flight_no' in self.task.ticket_info.keys():
            for li in ret:
                if self.task.ticket_info['flight_no'] == li[1] and self.task.ticket_info['ret_flight_no'] == li[2]:
                    self.res_num = 1
        return ret
...
if __name__ == '__main__':
    ...
    httpset_debug()
    # 如果没有出口ip，可以把下面哪行去掉，并且把爬虫服务请求代理的关键字变成req
    ...
    task.content = 'CAN&NYC&20170830&20170920'
