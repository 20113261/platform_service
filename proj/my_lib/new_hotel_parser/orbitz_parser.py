...
def orbitz_parser(content, url, other_info):
    hotel = Hotel()
...
if __name__ == '__main__':
    url = 'https://www.orbitz.com/Bruges-Woodlands-Hotels-Holiday-Park-Klein-Strand-Campground.h10000570.Hotel-Information?chkin=09%2F25%2F2016&chkout=09%2F26%2F2016&rm1=a1&hwrqCacheKey=476bdefd-70df-4a04-9485-958ac95f8d06HWRQ1471046052601&c=bf74cff5-fdda-446c-a812-e4f02b68136b&'
    other_info = {
        'source_id': '10000570',
        'city_id': '10041'
    }
    ...
    page.encoding = 'utf8'
    content = page.text
    result = orbitz_parser(content, url, other_info)
